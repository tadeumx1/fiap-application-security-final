...
app.get('/orders', checkJwt, errorHandler, checkScopes, async (req, res, next) => {
	var resp = await db.getAllOrders();
	res.status(200).json(resp);
});

app.post('/orders', checkJwt, errorHandler, checkScopes, async (req, res, next) => {
...
app.get('/orders/:id', checkJwt, errorHandler, checkScopes, async (req, res, next) => {
...
app.put('/orders/:id', checkJwt, errorHandler, checkScopes, async (req, res, next) => {
...
app.delete('/orders/:id', checkJwt, errorHandler, checkScopes, async (req, res, next) => {
